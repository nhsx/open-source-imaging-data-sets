...
const Introduction = ({ search, setSearch }) => (
   <section className="flex-1 flex flex-col justify-center py-16 md:py-24">
      <Container>
         <h1 className="text-3xl sm:text-6xl font-bold text-center tracking-tighter leading-tight text-gray-800">
...
const DataList = ({ search, setSearch }) => {
   ...
   return (
      <div className="relative flex flex-col">
         ...
         <div className="relative">
            ...
            <div className="relative z-[3] flex flex-col sm:h-[50vh]">
               <Header />
               <Introduction search={search} setSearch={setSearch} />
            </div>
         </div>
         ...
         <div className="relative">
            ...
            <div className="relative z-[3]">
               <DataList search={search} setSearch={setSearch} />
               <Footer />
            </div>
         </div>
      </div>
